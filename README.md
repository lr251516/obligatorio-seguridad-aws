...
| **IAM** | Keycloak 23.0.0 | OAuth2/OIDC + 3 roles + 3 usuarios |
...
**Estado:** ✅ 100% COMPLETADO - Deployment 100% automatizado
...
**Tiempo:** ~10-12 minutos (5 VMs + configuración automática)
...
**Esperado:** 5 agentes activos (wazuh-siem, waf-kong, vpn-iam, hardening-vm, grafana)
...
Opción 1 - OAuth2: Click "Sign in with Keycloak"
  - jperez@fosil.uy / Admin123! (Admin)
  - mgonzalez@fosil.uy / DevOps123! (Editor)
