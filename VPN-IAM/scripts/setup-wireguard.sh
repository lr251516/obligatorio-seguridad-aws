...
EOF
    ...
    echo ""
    echo "⚠️  IMPORTANTE: Editar el archivo y reemplazar la clave pública del cliente"
    echo ""
...
EOF
    ...
    echo "Archivo creado: /etc/wireguard/wg0.conf"
    echo ""
    echo "⚠️  IMPORTANTE: Editar el archivo y reemplazar la clave pública del servidor"
    echo ""
